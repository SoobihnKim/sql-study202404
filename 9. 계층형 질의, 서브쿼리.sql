...
-- 사원 이름이 이관심인 사람이 속해 있는 부서의 사원정보 조회
...
-- 20200525에 받은 급여가 회사전체의 20200525일 전체 평균 급여보다 
-- 높은 사원들의 정보(사번, 이름, 급여지급일, 받은급여액수) 조회

-- 회사전체의 20200525일 전체 평균 급여
-- 그 평균보다 높은 사원 조회
SELECT
    E.emp_no,
    E.emp_nm,
...
-- 부서원이 2명 이상인 부서 중에서
-- 각 부서의 가장 연장자의 사번과 이름 생년월일과 부서코드를 조회
